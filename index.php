...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="start.php" class="btn btn-lg btn-success">Démarrer</a>
	  <a href="stop.php" class="btn btn-lg btn-danger">Arrêter</a>
	  
	  <br/> <br/>
	  
		<table class="table table-bordered table-striped table-hover">
			<tr> <th>id</th> <th>start</th> <th>stop</th> <th>comment</th> </tr>
		  	<?php
		  	foreach($tss as $ts) {
