...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="<?= app_base_path() ?>/css/bootstrap.min.css" rel="stylesheet">
	<link href="<?= app_base_path() ?>/css/bootstrap-theme.min.css" rel="stylesheet">
	
	<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	<link href="<?= app_base_path() ?>/css/ie10-viewport-bug-workaround.css" rel="stylesheet">
	
	<!-- Custom styles for this template -->
	<link href="<?= app_base_path() ?>/css/index.css" rel="stylesheet">
	
	<!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
	<!--[if lt IE 9]><script src="js/ie8-responsive-file-warning.js"></script><![endif]-->
	<script src="<?= app_base_path() ?>/js/ie-emulation-modes-warning.js"></script>
	...
	<script src="<?= app_base_path() ?>/js/bootstrap.min.js"></script>
	<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	<script src="<?= app_base_path() ?>/js/ie10-viewport-bug-workaround.js"></script>
